...
st.set_page_config(page_title='GUVI - GPT',page_icon=icon, menu_items={"about":'This streamlit application was developed by Manoj'})

# Connect to TiDB Cloud database
mydb = mysql.connector.connect(
    host='localhost', # Replace with your TiDB host URL
    port=3306,
    user='root', # Replace with your TiDB username
    password='8312'  # Replace with your TiDB password
)
